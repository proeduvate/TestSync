...
import { FiCalendar, FiClock, FiCheckCircle, FiInfo, FiArrowLeft, FiDollarSign, FiUsers } from 'react-icons/fi';
                            ...
                            <div className="info-grid">
                                <div className="info-row">
                                    ...
                                    <div className="info-content">
                                        ...
                                        <span className="info-value" style={{ color: 'var(--primary-light)', fontWeight: 600 }}>{formatCredits(task.credits || task.budget)}</span>
                                    </div>
                                </div>
                                <div className="info-row">
                                    ...
                                    <div className="info-content">
                                        ...
                                        <span className="info-value">{task.openSlots ?? 0}</span>
                                    </div>
                                </div>
                                <div className="info-row">
